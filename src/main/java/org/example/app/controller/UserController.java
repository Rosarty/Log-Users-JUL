...
public class UserController {
    ...
    public void createUser() {
        ...
        String res = service.createUser(data);
    ...
    public void readUserById() {
        ...
        String res = service.readUserById(data);
        if (res.equals(Constants.DB_ABSENT_MSG)) {
            view.getOutput(res);
            System.exit(0);
        } else {
    ...
    public void updateUser() {
        ...
        String res = service.updateUser(data);
        if (res.equals(Constants.DB_ABSENT_MSG)) {
            view.getOutput(res);
            System.exit(0);
        } else {
    ...
    public void deleteUser() {
        ...
        String res = service.deleteUser(data);
        if (res.equals(Constants.DB_ABSENT_MSG)) {
            view.getOutput(res);
            System.exit(0);
        } else {
